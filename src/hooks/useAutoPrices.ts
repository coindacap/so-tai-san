...
export type RefreshOpts = {
  /**
   * true = ghi giá vàng vào store dù autoGoldPrice tắt
   * (vd. user bấm “Áp dụng giá vàng ước” trên màn Giá)
   */
  forceGold?: boolean
}
...
export function useAutoPrices(enabled = true) {
  ...
  const applyLive = useCallback(
    async (silent = false, opts?: RefreshOpts) => {
